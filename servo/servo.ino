...
const int buttonApin = 6; // CLose Servo
const int buttonBpin = 7; // Open Servo
const int buttonCpin = 8; // Servo 90 degs
...
void loop () {
  ...
  if ( (millis() - lastDebounceTimeA) > debounceDelay) {
    ...
    if ( (buttonAState == HIGH) && (servoClosed < 0 ) ) {
  ...
  if ( (millis() - lastDebounceTimeB) > debounceDelay) {
    ...
    if ( (buttonBState == HIGH) && (servoOpen < 0 ) ) {
  ...
  if ( (millis() - lastDebounceTimeC) > debounceDelay) {
    ...
    if ( (buttonCState == HIGH) && (servo90 < 0 ) ) {
