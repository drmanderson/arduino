...
const int ce_pin = 4; // Connect Pin 15 to !CE (clock enable, active low)
const int data_pin = 5; // Connect Pin 9 to SER_OUT (serial data out)
const int clk_pin = 6; // Connect Pin 2 to CLK (the clock that times the shifting)
const int shld_pin = 7; // Connect Pin 1 to SH/LD (shift or active low load)
