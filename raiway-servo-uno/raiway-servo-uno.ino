...
const int point_3_open_angle = 140;
const int point_3_close_angle = 60;
const int point_4_open_angle = 120;
const int point_4_close_angle = 60;
...
void setup() {
  ...
  move_servo(point_3, point_3_close_angle);
  move_servo(point_4, point_4_close_angle);  
}
...
void readOffButtons() {
    ...
    if (digitalRead(buttonBpin) == LOW )  {
      ...
      move_servo(point_3,point_3_open_angle);
      move_servo(point_4,point_4_open_angle);      
    }
}
